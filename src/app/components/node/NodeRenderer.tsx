...
export function NodeRenderer({node}: NodeRendererProps) {
    ...
    return (
        ...
        >
            <div
                className='border-b border-stone-100 flex items-center justify-center font-medium h-10 rounded-tr-2xl rounded-tl-2xl'
                style={{backgroundColor: node.color}}>
                <h1 className='text-white'>{node.name}</h1>
            </div>
