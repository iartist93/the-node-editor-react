  ...
  return (
    <div className='flex flex-col relative py-3'>
      ...
      <SliderSocket
        ...
        max={1}
        name={'roughness'}
        onChange={(name, value) => setRoughness(value)}
      />
      ...
      <SliderSocket
        ...
        max={1}
        name={'metallic'}
        onChange={(name, value) => setMetallic(value)}
      />
      ...
      <SliderSocket
        ...
        onChange={(name, value) => setEmissiveIntensity(value)}
      />
      ...
      <SliderSocket
        ...
        onChange={(name, value) => setWireframeLinewidth(value)}
      />
    </div>
  );
}
